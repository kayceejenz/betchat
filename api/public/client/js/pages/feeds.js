                        ...
                        <div class="bg-white border mt-2">
                            <div>
                                <div class="d-flex flex-row justify-content-between align-items-center p-2 border-bottom">
                                    <div class="d-flex flex-row align-items-center feed-text px-2"><img class="rounded-circle" src="${feed.postedBy?.image}" width="45">
                                        <div class="d-flex flex-column flex-wrap ml-2"><span class="font-weight-bold">${feed.postedBy?.fullname}</span><span class="text-black-50 time">${new Date(feed.createdAt).toLocaleDateString()} ${new Date(feed.createdAt).toLocaleTimeString()}</span></div>
                                    </div>
                                    <div class="feed-icon px-2"><i class="fa fa-ellipsis-v text-black-50"></i></div>
                                </div>
                            </div>
                            <div class="p-2 px-3"><h5>${feed.title}</h5></div>
                            <div class="p-2 px-3"><span>${feed.body}</span></div>
