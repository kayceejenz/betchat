...
app.get("/js/bootstrap", (req,res) => res.sendFile(__dirname+"/api/public/client/js/libs/bootstrap.min.js"));
app.get("/js/popper", (req,res) => res.sendFile(__dirname+"/api/public/client/js/libs/popper.min.js"));
